...
import { userSchemaSignUp, userSchemaSignIn } from "../schemas/userSchema.js";
...
export async function verifyEmailConflict(req: Request, res: Response, next: NextFunction) {
